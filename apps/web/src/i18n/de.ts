...
export const de: Translations = {
  ...
  landingDescription: "Eine private Khatm-Verwaltungs-App für die Stammtisch-Gruppe von Haus Des Islam. Wähle deine Abschnitte, verfolge deinen Fortschritt und vollende den Quran als Gemeinschaft.",
  getStarted: "Loslegen",
  ...
  claimWarning: "Indem du diesen Abschnitt übernimmst, verpflichtest du dich, die Seiten {start}–{end} des Qurans diesen Monat zu lesen. Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  completeWarning: "Bist du sicher, dass du die Seiten {start}–{end} gelesen hast? Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  regenerateWarning: "Dies löscht alle aktuellen Abschnitte und Ansprüche für diesen Monat und erstellt neue. Dies kann nicht rückgängig gemacht werden!",
