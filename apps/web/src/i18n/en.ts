export const en = {
  ...
  landingDescription: "A private Khatm management app for the Stammtisch group of Haus Des Islam. Claim your segments, track your progress, and complete the Quran as a community.",
  ...
  claimWarning: "By claiming this segment, you take responsibility to read pages {start}–{end} of the Quran this month. This action cannot be undone.",
  ...
  regenerateWarning: "This will delete all current segments and claims for this month and create new ones. This cannot be undone!",
