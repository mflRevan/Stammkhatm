export const en = {
  ...
  segmentTaken: 'Claimed by someone else',
  daysLeft: 'Days left',
  splitStatus: 'Quran splitting',
  splitActive: 'Active',
  splitDisabled: 'Disabled',
  unclaimedUsers: 'Unclaimed users',
  everyoneClaimed: 'Everyone has claimed a segment.',
  ...
  releaseTitle: 'Release Segment',
  releaseWarning:
    'Releasing pages {start}–{end} will make this segment available for another participant. Continue?',
  ...
  splitEnabled: 'Splitting',
  reminderIntervalDays: 'Reminder Interval (days)',
  reminderTarget: 'Reminder target',
  reminderTargetClaims: 'Users with incomplete claims',
  reminderTargetUnclaimed: 'Users without any claims',
  reminderTemplate: 'Reminder template',
  reminderTemplateHint: 'Use [username] and [segment_name] placeholders.',
  reminderMessagePlaceholder: 'Custom reminder message (placeholders supported)…',
  reminderDefault: 'Assalamu Alaikum [username], please complete [segment_name].',
  reminderModalDesc: 'Send a reminder without revealing the claimant identity.',
  reminderSent: 'Reminder sent',
  remindUnclaimed: 'Remind unclaimed users',
  segmentStatus: 'Segment status',
  segmentStatusDesc: 'Track claimed, completed, and missing segments.',
  unclaimedUsersDesc: 'These users have not claimed any segment yet.',
